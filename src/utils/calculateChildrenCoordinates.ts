...
export const calculateChildrenDates = (
  day: number,
  month: number,
  year: number,
) => {
  ...
  const _twentyOne = computeSum(month + twentyTwo);
  const twentyThree = computeSum(six + twentyTwo);
  const twentyFour = computeSum(eight + ten);
  const _twentyTwo = computeSum(month + twentyFour);
  const _twentyThree = computeSum(twentyTwo + twentyFour);
  const _twentyFour = computeSum(month + six);

  const twentyFive = computeSum(eight + twentyFour);
  const twentySix = computeSum(seven + ten);
  const _twentyFive = computeSum(twentyFour + twentySix);
  const _twentySix = computeSum(twentyFour + six);

  const twentySeven = computeSum(seven + twentySix);
  const _twentySeven = computeSum(twentySix + six);

  const twentyEight = computeSum(nine + ten);
  const twentyNine = computeSum(nine + twentyEight);
  const _twentyEight = computeSum(six + twentyNine);

  const thirty = computeSum(twenty + five);
  const thirtyOne = computeSum(thirteen + five);
  const _twentyNine = computeSum(six + thirtyOne);
  const _thirty = computeSum(twentyNine + thirtyOne);

  const thirtyTwo = computeSum(five + ten);
  const _thirtyOne = computeSum(six + thirtyTwo);
